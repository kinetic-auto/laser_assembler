...
get_filename_component(_filename "/home/sander/ros/src/laser_assembler/srv/AssembleScans.srv" NAME_WE)
add_custom_target(_laser_assembler_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "laser_assembler" "/home/sander/ros/src/laser_assembler/srv/AssembleScans.srv" "std_msgs/Header:geometry_msgs/Point32:sensor_msgs/ChannelFloat32:sensor_msgs/PointCloud"
)

get_filename_component(_filename "/home/sander/ros/src/laser_assembler/srv/AssembleScans2.srv" NAME_WE)
add_custom_target(_laser_assembler_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "laser_assembler" "/home/sander/ros/src/laser_assembler/srv/AssembleScans2.srv" "std_msgs/Header:sensor_msgs/PointField:sensor_msgs/PointCloud2"
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/laser_assembler)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/laser_assembler\")")
  # install generated code
  install(
